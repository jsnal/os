...
ssize_t PTSInode::read(FileDescriptor&, size_t start, size_t length, u8* buffer)
{
    return 0;
}

ssize_t PTSInode::write(FileDescriptor&, size_t start, size_t length, u8* buffer)
{
    return 0;
}

ssize_t PTSInode::get_dir_entries(FileDescriptor&, u8* buffer, ssize_t count)
{
    return 0;
}

int PTSInode::fstat(FileDescriptor&, stat&)
{
    return 0;
}
