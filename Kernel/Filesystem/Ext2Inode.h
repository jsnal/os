...
public:
    ...
    ResultReturn<InodeId> find(const String&) override;
    ResultReturn<ssize_t> read(size_t start, size_t length, u8* buffer, FileDescriptor&) override;
    ResultReturn<ssize_t> write(size_t start, size_t length, u8* buffer, FileDescriptor&) override;
